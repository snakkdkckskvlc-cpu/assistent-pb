...
там, где совпадают термины, но слепа к синонимам и словоформам (стемминга
здесь нет, «неустойки» и «неустойка» для BM25 разные токены).
...
# Токенизация без стемминга: буквы и цифры, всё в нижний регистр. Цифры
# принципиально сохраняем — «333», «123-ФЗ», «5.13130» несут здесь основную
# различающую силу.
